...
dotnet-lambda deploy-serverless `
    --stack-name $developerPrefix-pecuniary-securitycommand-stack `
...
$stack = aws cloudformation describe-stacks --stack-name $developerPrefix-pecuniary-securitycommand-stack | ConvertFrom-Json
...
Write-Host "`n`n YOUR STACK NAME IS:   $developerPrefix-pecuniary-securitycommand-stack   `n`n"
